  ...
  return  <div>
      ...
      <div className="row">
        ...
        <div className="col-sm-3">
          <div className="Grid-icons" onClick={() => pageAddCustomRow({ langId: lang, type: '@hotelSearch'})}>
        ...
        <div className="col-sm-3" onClick={() => pageAddCustomRow({ langId: lang, type: '@toursSearch'})}>
        ...
        <div className="col-sm-3" onClick={() => pageAddCustomRow({ langId: lang, type: '@showPlacesSearch'})}>
          <div className="Grid-icons">
            <div className="Grid-icons__inner">
