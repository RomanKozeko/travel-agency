...
class SliderForm extends Component {
    render() {
        const { handleSubmit, languages, pagesImgPath, updloadImg, cancel, pages, item, setLinkUrl } = this.props;
        return (
                    ...
                    <div className={css(styles.sliderItem)}>
                        ...
                        />
                        {
                            <div className={css(styles.langWrap)}>
                                ...
                                <Field name={'color'} className={css(styles.fieldInput)} component="input" type="text" />
                            </div>
                        }
                        {languages.map(lang => (
                        ...
                        <Button type="submit" className={css(styles.button)} color="primary">
                            Сохранить
                        </Button>
                        <Button onClick={cancel} className={css(styles.button)} type="submit">
                            Отмена
                        </Button>
                    </div>
                </form>
