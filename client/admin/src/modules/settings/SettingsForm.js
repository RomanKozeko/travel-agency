              ...
              <table className={css(styles.table)}>
                <tbody>
                  <tr>
                    ...
                    {languages.map(lang => (
                      <th className={css(styles.th)} key={lang._id}>
                        {' '}
                        {lang.prefix}{' '}
                      </th>
                    ))}
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        ...
                        key={`${lang._id}_appTitle`}
                      >
                        <Field
                          name={`content.${lang._id}.appTitle`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}_appDescription`}
                      >
                        <Field
                          name={`content.${lang._id}.appDescription`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td className={css(styles.td)} key={lang._id}>
                        <Field
                          name={`content.${lang._id}.tourInfo`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}_tourDescription`}
                      >
                        <Field
                          name={`content.${lang._id}.tourDescription`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}showPlaces`}
                      >
                        <Field
                          name={`content.${lang._id}.showPlaces`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}accommodation`}
                      >
                        <Field
                          name={`content.${lang._id}.accommodation`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}tourProgram`}
                      >
                        <Field
                          name={`content.${lang._id}.tourProgram`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}includedInPrice`}
                      >
                        <Field
                          name={`content.${lang._id}.includedInPrice`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}notIncludedInPrice`}
                      >
                        <Field
                          name={`content.${lang._id}.notIncludedInPrice`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}daysAmount`}
                      >
                        <Field
                          name={`content.${lang._id}.daysAmount`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}tourType`}
                      >
                        <Field
                          name={`content.${lang._id}.tourType`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}orderTour`}
                      >
                        <Field
                          name={`content.${lang._id}.orderTour`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}orderHotel`}
                      >
                        <Field
                          name={`content.${lang._id}.orderHotel`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}ourContacts`}
                      >
                        <Field
                          name={`content.${lang._id}.ourContacts`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}followUs`}
                      >
                        <Field
                          name={`content.${lang._id}.followUs`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}copyRight`}
                      >
                        <Field
                          name={`content.${lang._id}.copyRight`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}mostInteresting`}
                      >
                        <Field
                          name={`content.${lang._id}.mostInteresting`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}departureInfo`}
                      >
                        <Field
                          name={`content.${lang._id}.departureInfo`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}foodType`}
                      >
                        <Field
                          name={`content.${lang._id}.foodType`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}downloadTourProgram`}
                      >
                        <Field
                          name={`content.${lang._id}.downloadTourProgram`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}moreInfo`}
                      >
                        <Field
                          name={`content.${lang._id}.moreInfo`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}emailSentMessage`}
                      >
                        <Field
                          name={`content.${lang._id}.emailSentMessage`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}emailSentContactsMessage`}
                      >
                        <Field
                          name={`content.${lang._id}.emailSentContactsMessage`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
                  ...
                  <tr>
                    ...
                    {languages.map(lang => (
                      <td
                        className={css(styles.td)}
                        key={`${lang._id}notFound`}
                      >
                        <Field
                          name={`content.${lang._id}.notFound`}
                          className={css(styles.fieldInput)}
                          component="input"
                          type="text"
                        />
...
export default compose(
  connect(
    mapStateToProps,
    { loadItems, uploadImage: change, saveItem, fetchCurrencies }
  ),
  withHandlers({
