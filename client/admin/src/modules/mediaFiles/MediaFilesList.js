        ...
        return !filesType || item.type === filesType ? (
          <div key={item._id} className={css(styles.itemWrapper)}>
            <div
              ...
              className={
                item.active
                  ? css(styles.imgWrapper, styles.active)
            ...
            >
              ...
              <div className={css(styles.inner)}>
                <img
                  ...
                  src={
                    filesType === '@docs'
                      ? '/admin/build/ic_insert_drive_file_black_24px.svg'
                      : item.path
                  }
                  alt=""
                />
                ...
                return (
                  <div key={lang._id}>
                    ...
                    <input
                      ...
                      onChange={({ target }) =>
                        updateItemContent(item._id, lang._id, target.value)
                      }
