import { createReducer, getFiltersQuery, createBasicActions } from '../../services/utils';
...
const fetchFilteredShowplaces = (filtersQuery) => ({
  [CALL_API]: {
    types: ['FILTERED_SHOWPLACES_REQUEST', 'FILTERED_SHOWPLACES_SUCCESS', 'FILTERED_SHOWPLACES_FAILURE'],
    method: 'GET',
