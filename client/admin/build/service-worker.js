...
var precacheConfig = [
    ['/admin/build/index.html', '120246e9f3c57cf8ca68e17bb00505ee'],
    [
      '/admin/build/static/css/main.4867cbfb.css',
      '2f5d41201db7161f807e57869e317f1c',
    ],
    [
      '/admin/build/static/js/main.256b3745.js',
      '7b2c8d1fbfa86690c1767c173c9cc57f',
    ],
  ],
  cacheName =
  ...
  self.addEventListener('fetch', function(e) {
    if ('GET' === e.request.method) {
      ...
      !t &&
        ...
        ((n = new URL('/admin/build/index.html', self.location).toString()),
        (t = urlsToCacheKeys.has(n))),
        t &&
          e.respondWith(
            caches
