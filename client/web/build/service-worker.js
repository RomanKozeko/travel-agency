...
var precacheConfig = [
    ['index.html', '3f82338f8365c6e56ff8dda99e4e2a1c'],
    ['static/css/main.3f4a19b5.css', 'c39d37cb8a8317643d1533427141dc65'],
    ['static/js/main.9d4e51aa.js', 'c1ef3144c5dfc0aa145518a9e055e462'],
    [
      'static/media/ic_done_black_24px.f34742d5.svg',
      'f34742d5b0171ce16b9f9eaab1699018',
    ],
  ],
  cacheName =
  ...
  self.addEventListener('fetch', function(e) {
    if ('GET' === e.request.method) {
      ...
      !t &&
        ...
        ((n = new URL('/web/build/index.html', self.location).toString()),
        (t = urlsToCacheKeys.has(n))),
        t &&
          e.respondWith(
            caches
