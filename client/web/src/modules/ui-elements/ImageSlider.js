...
const ImageSlider = ({ images, languageID, currIndex, nextSlide, prevSlide, hover, mouseLeave }) =>
  <div className={css(styles.wrapper)} onMouseEnter={ hover } onMouseLeave={ mouseLeave }>
    {
      images.length > 1 ?
        <div>
    ...
    }
    {
      images.map((img, index) => {
        ...
        return <img className={css(styles.imgPlaceHolder)} src={ img.path } key={ img._id } />
      })
    }
