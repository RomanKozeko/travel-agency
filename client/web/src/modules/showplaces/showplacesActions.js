...
export const fetchFilteredShowplaces = (filterQuery, lang) => ({
	[CALL_API]: {
		types: [ SHOWPLACES_FILTERED_REQUEST, SHOWPLACES_FILTERED_SUCCESS, SHOWPLACES_FILTERED_FAILURE ],
...
export const loadFilteredShowplaces = (filterQuery) => (dispatch, getState) => {
	...
	dispatch(fetchFilteredShowplaces(filterQuery, getState().app.languages.urlPrefix))
};
